...
CLANG32_SCRIPTS_URL="https://raw.githubusercontent.com/mikebeaton/ocbuild/master/scripts/"
CLANG32_SCRIPTS=(
  "fix-macho32"
  "libtool32"
)
...
"${CURL}" -LfsO "https://github.com/mikebeaton/ocbuild/releases/download/llvm-kext32-latest/${CLANG32_ZIP}" || ret=$?
if [ $ret -ne 0 ]; then
