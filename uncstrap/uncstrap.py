...
def download_uncrustify_conf():
    response = requests.get('https://raw.githubusercontent.com/mikebeaton/ocbuild/master/uncstrap/configs/' + UNC_CONF, timeout=5)
...
def download_uncrustify_bin():
    ...
    response = requests.get('https://raw.githubusercontent.com/mikebeaton/ocbuild/master/external/' + zip_name, timeout=5)
    real_filename = response.text

    response = requests.get('https://raw.githubusercontent.com/mikebeaton/ocbuild/master/external/' + real_filename, timeout=5)
